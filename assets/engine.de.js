...
(function () {
  ...
  PACKS.de = {
    ...
    rules: {
      ...
      id_label: {
        pattern: /((?:Antragsnummer|Kundennummer|Vorgangs-?ID|Vorgangsnummer|Rechnungsnr\.?|Rechnungsnummer|Bestellnummer|Ticketnummer|Referenz)\s*[:：=]\s*)([A-Za-z]{0,6}-?\d[\dA-Za-z\-_.]{3,80})/giu,
        tag: "REF",
        mode: "prefix"
      },
