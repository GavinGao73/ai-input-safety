...
(function () {
  ...
  PACKS.de = {
    ...
    phoneGuard: function ({ label, value, match }) {
      ...
      if (
        /\b(?:kundennummer|rechnungsnr|rechnungsnummer|bestellnummer|vorgangs-?id|antragsnummer|referenz|ticketnummer)\b/i.test(
          lbl
        )
      ) {
        return false;
    ...
    rules: {
      ...
      phone: {
        ...
        // 2) include "mobil" + "fax" labels
        // 3) intl branch:
        //    - require country code not zero: 00[1-9]\d{0,2}
        //    - require not preceded by letter/digit/_/- to avoid IDs like "KND-0049..."
        pattern:
